import { GetReferrerVisitorsResponse } from "@/types/analytics";
...
export async function GET(
  ...
  try {
    ...
    if (!id) {
      return NextResponse.json<GetReferrerVisitorsResponse>(
    ...
    const backendRes = await fetch(
      `${API_URL}/analytics/${id}/referrer-visitors?start=${start}&end=${end}&limit=${limit}`,
      {
        method: "GET",
        headers: {
    ...
    return NextResponse.json<GetReferrerVisitorsResponse>(data, {
