...
export async function GET(
  ...
  try {
    ...
    if (!id) {
      return NextResponse.json<GetPageVisitorsResponse>(
    ...
    const backendRes = await fetch(
      `${API_URL}/analytics/${id}/pages?start_date=${startDate}&end_date=${endDate}&limit=${limit}`,
      {
        method: "GET",
        headers: {
    ...
    return NextResponse.json<GetPageVisitorsResponse>(data, {
